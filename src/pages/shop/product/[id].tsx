                ...
                <div className='container'>
                    <div className='shop_inner_products_product_page_inner'>
                        ...
                        <div className='shop_inner_products_product_page_content'>
                            ...
                            <div className='shop_inner_products_product_page_content_price'>{product.price} $ <span>(долар, без урахування доставки)</span></div>
                    ...
                    <div className='shop_inner_products_product_page_information'>
                            ...
                            {!informationState ? 
                                ...
                                : <div className='shop_inner_products_product_page_information_content_сharacteristics'>
                                    ...
                                    {сharacteristics.length > 2 ? 
                                        <div onClick={() => setMoreCharacteristics(!moreCharacteristics)} className='shop_inner_products_product_page_information_content_сharacteristics_button' >
